...
//
// This file is committed in your app. Khotan-owned table shapes are versioned;
// run `khotan-data doctor` after edits or package upgrades.
// It has zero runtime dependencies on khotan-data.
//
...
// ---------------------------------------------------------------------------
// khotan_runtime_schema — singleton metadata row for Khotan-owned tables
// ---------------------------------------------------------------------------
...
export type KhotanRuntimeSchema = typeof khotanRuntimeSchema.$inferSelect;
